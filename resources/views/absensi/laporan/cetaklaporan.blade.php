...
<body class="A4">
  ...
  <section class="sheet padding-10mm">
    ...
    <table class="tablepresensi">
      ...
      @foreach ($absen as $a)
      @php
      $pathIn = Storage::url('uploads/absensi/'. $a->foto_masuk);
      $pathOut = Storage::url('uploads/absensi/'. $a->foto_keluar);
      @endphp
      <tr>
        ...
        <td>
          <img src="{{url($pathIn)}}" alt="" class="foto">
        </td>
        ...
        <td>
          ...
          <img src="{{url($pathOut)}}" alt="" class="foto">
          @else
          Tidak ada foto.
          @endif
        </td>
