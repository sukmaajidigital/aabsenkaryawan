    ...
    <div class="collapse navbar-collapse" id="sidebar-menu">
      <ul class="navbar-nav pt-lg-3">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle {{ request()->is(['user', 'absen']) ? 'show' : '' }}" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="{{ request()->is(['user', 'absen']) ? 'true' : '' }}">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          <div class="dropdown-menu {{ request()->is(['user', 'absen']) ? 'show' : '' }}">
            <div class="dropdown-menu-columns">
              <div class="dropdown-menu-column">
                <a class="dropdown-item {{ request()->is(['user']) ? 'active' : '' }}" href="{{route('user.index')}}">
                  Data Karyawan
                </a>
                <a class="dropdown-item {{ request()->is(['absen']) ? 'active' : '' }}" href="{{route('absen.index')}}">
                  Data Absen
                </a>
              </div>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->is(['absen/monitor']) ? 'active' : '' }}" href="{{route('absen.monitor')}}">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
              <!-- Download SVG icon from http://tabler-icons.io/i/home -->
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->is(['absen/izinsakit']) ? 'active' : '' }}" href="{{route('absen.izinsakit')}}">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
              <!-- Download SVG icon from http://tabler-icons.io/i/home -->
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle {{ request()->is(['absen/laporan', 'absen/rekap']) ? 'show' : '' }}" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="{{ request()->is(['absen/laporan', 'absen/rekap']) ? 'true' : '' }}">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
              <!-- Download SVG icon from http://tabler-icons.io/i/package -->
          ...
          <div class="dropdown-menu {{ request()->is(['absen/laporan', 'absen/rekap']) ? 'show' : '' }}">
            <div class="dropdown-menu-columns">
              <div class="dropdown-menu-column">
                <a class="dropdown-item {{ request()->is(['absen/laporan']) ? 'active' : '' }}" href="{{route('absen.laporan')}}">
                  Absensi
                </a>
                <a class="dropdown-item {{ request()->is(['absen/rekap']) ? 'active' : '' }}" href="{{route('absen.rekap')}}">
                  Rekap Absensi
                </a>
              </div>
            </div>
