        ...
        <div class="card card-sm">
          <div class="card-body">
            <div class="row align-items-center">
              ...
              <div class="col">
                <div class="font-weight-medium">
                  {{$rekapIzin->jumlah_izin !== null ? $rekapIzin->jumlah_izin  : 0}}
                </div>
                <div class="text-secondary">
                  Karyawan Izin
                </div>
              ...
              <div class="col-auto">
                <span class="bg-warning text-white avatar">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-mood-sick" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <path d="M9 10h-.01" />
                    <path d="M15 10h-.01" />
                    <path d="M8 16l1 -1l1.5 1l1.5 -1l1.5 1l1.5 -1l1 1" /></svg>
                </span>
              </div>
              <div class="col">
                <div class="font-weight-medium">
                  {{$rekapIzin->jumlah_sakit !== null ? $rekapIzin->jumlah_sakit  : 0}}
                </div>
                <div class="text-secondary">
                  Karyawan Sakit
                </div>
